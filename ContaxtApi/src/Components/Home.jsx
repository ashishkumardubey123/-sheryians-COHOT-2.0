        ...
        <div className="bg-black/60 w-full h-full flex items-center justify-center">
          <div className="text-center text-white px-6">
            ...
            <p className="mt-4 text-lg text-gray-200 max-w-xl mx-auto">
              Premium clothing crafted for comfort, confidence, and everyday
              style.
            </p>
      ...
      <section className="py-20 bg-gray-100 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            We believe clothing should feel as good as it looks. Every piece is
            designed with premium fabrics, attention to detail, and a modern
            aesthetic — made for people who value style without compromise.
          </p>
        </div>
      </section>
